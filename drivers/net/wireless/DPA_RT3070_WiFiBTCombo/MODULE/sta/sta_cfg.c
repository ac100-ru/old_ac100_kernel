	...
	IN	PSTRING			arg)
{
	...
	{
		AsicDisableSync(pAd);
		WscBuildBeaconIE(pAd, pWscControl->WscConfStatus, FALSE, 1, pWscControl->WscConfigMethods, BSS0);
		WscBuildProbeRespIE(pAd, WSC_MSGTYPE_REGISTRAR, pWscControl->WscConfStatus, FALSE, 1, pWscControl->WscConfigMethods, BSS0);
